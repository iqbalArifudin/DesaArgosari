                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <p>
                                            <center><button type="button" class="btn btn-outline-secondary"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="card-header">
                                                <center><strong>Foto Profil</strong></center>
                                            </div>
                                            <div class="card-body">
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <center><img
                                                                src="<?= base_url('assets/foto_penduduk/') . $penduduk->foto ?>"
                                                                class="card-img-top" style="height: 470px;">
                                                        </center>
                                                    </div>
                                                    <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label"
                                                            for="customFile"><?= $penduduk->foto ?></label>

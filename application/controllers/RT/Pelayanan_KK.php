...
class Pelayanan_KK extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('RT/Pelayanan/KK/index', $data);
        $this->load->view('template RT/footer', $data);
    }

    public function hapus($id_kepala_kel)
    {
        if ($this->KK_model->hapusDataKtp($id_kepala_kel) == false) {
            ...
            redirect('RT/Pelayanan_KK', 'refresh');
        }
    }
    ...
    public function edit($id_kepala_kel)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('template RT/sidebar', $data);
            $this->load->view('template RT/topbar', $data);
            $this->load->view('RT/Pelayanan/KK/detail', $data);
            $this->load->view('template RT/footer', $data);
        } else {

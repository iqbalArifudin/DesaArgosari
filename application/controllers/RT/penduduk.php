...
class penduduk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('RT/penduduk/index', $data);
    ...
    public function tambahpenduduk()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('RT/penduduk/tambah', $data);
    ...
    public function edit($id_penduduk)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('template RT/sidebar', $data);
            $this->load->view('template RT/topbar', $data);
            $this->load->view('RT/penduduk/edit', $data);
            $this->load->view('template RT/footer', $data);
        } else {
    ...
    public function detail($id_penduduk)
    {
        ...
        $this->load->view('template RT/sidebar');
        $this->load->view('template RT/topbar');
        $this->load->view('RT/penduduk/detail', $data);
        $this->load->view('template RT/footer');
    }
}
